...
@RequestMapping("/api")
 public class PersonController {
    ...
    public PersonDTO getBuyerById(@PathVariable Long personId) {
        return personService.getPurchases(personId);
    }

    @GetMapping("/persons/{personId}/sales")
    public PersonDTO getPurchases(@PathVariable Long personId) {
        return personService.getSales(personId);
    }
}