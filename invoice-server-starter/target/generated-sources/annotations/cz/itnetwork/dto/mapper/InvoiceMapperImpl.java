...
public class InvoiceMapperImpl implements InvoiceMapper {
    ...
    public InvoiceEntity toEntity(InvoiceDTO source) {
        ...
        invoiceEntity.setBuyer( source.getBuyer() );
        invoiceEntity.setSeller( source.getSeller() );
    ...
    public InvoiceDTO toDTO(InvoiceEntity source) {
        ...
        invoiceDTO.setBuyer( source.getBuyer() );
        invoiceDTO.setSeller( source.getSeller() );
